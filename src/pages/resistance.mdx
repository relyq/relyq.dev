...
you should read this through completely the first time

the goal is for you to understand the anatomy information at the end by performing movements - understanding this will give you the freedom to build your own program
