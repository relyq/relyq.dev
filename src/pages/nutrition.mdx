...
# MEAL PLANNING
the way you're supposed to use this is by finding your calorie goal & macro ratios, and choosing whatever food you like to fit your macros \
the guide is comprised of some principles and approximated servings that should lead to a healthy plan with enough freedom to pick foods you enjoy \
you should always find out the calories and macro composition of the food you're adding to your plan - you can google "[food name] nutrition"

<div>
- first of all find your TDEE and macro ratios
  - https://tdeecalculator.net/
  - your TDEE is the total energy in calories that your body burns every day
  - this determines your maintenance/cutting/bulking calories
  - on a deficit, you'll burn body fat to make it through the day
  - on a bulk, you'll use the extra calories to build more muscle, but also body fat
  - you can burn body fat and build muscle at the same time (body recomposition) at a slight deficit (~200 cals) while resistance training
</div>
...
- consider supplements, spices, and herbs
  - multivits as insurance to make sure micros are covered
